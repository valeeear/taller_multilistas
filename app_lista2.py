...
def fnt_selector(opcion):
    ...
    if opcion == '1':
        ...
        ciudad = input('CIUDAD:   ')
        sexo = input('SEXO:   ')
        if edad >= 25 or edad <=35 and profesion == 'Ing. sistemas' or profesion== 'Ing. informatica' and experiencia >= 2 or edad <=4:
            print('Has sido regisrado en la lista para la seleccion de empleados')
